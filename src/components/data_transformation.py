...
class DataTransformation:
    ...
    def get_data_transformation_config(self):
        ...
        try:
            ...
            # Defining the columns that should be ordinal and the column that should be numerical
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            logging.info('Applying the preprocessing object on training and testing datasets')
            ...
            logging.info('Saved the preprocessing pickle file')
